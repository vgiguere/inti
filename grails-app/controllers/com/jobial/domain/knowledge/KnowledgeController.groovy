...
class KnowledgeController {
    ...
    def giveAnswer = {
        Question question = Question.load(params.questionId)
        question.addToAnswers(new Answer(text: params.answer, owner: Member.load(1)).save())
        question.save()

        return redirect(controller:"knowledge", action:'show', id:question.id)
